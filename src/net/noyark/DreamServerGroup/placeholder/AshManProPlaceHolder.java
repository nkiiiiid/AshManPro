...
public class AshManProPlaceHolder implements PlaceHolder {
    ...
    private static final EnumMap<MessageEnum, Integer> enumMap = new EnumMap<MessageEnum, Integer>(MessageEnum.class);

    static {
        enumMap.put(MessageEnum.ItemCount, 0);
        enumMap.put(MessageEnum.EntityCount, 1);
    }
